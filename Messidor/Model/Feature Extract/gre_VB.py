...
def process_images(input_folder, mask_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith('.tif'):  # 确保文件是TIFF图像文件
            ...
            mask_filename = 'result_' + filename
...
# 设置输入和输出文件夹路径
input_folder= "/home/ubuntu/fy/diabetic retinopathy/feature selection/data/messi"
mask_folder = "/home/ubuntu/fy/diabetic retinopathy/feature selection/data/seg_VB"
output_folder = "/home/ubuntu/fy/diabetic retinopathy/feature selection/data/seg_VB_ori"
